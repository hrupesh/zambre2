...
<html lang="en">
    <head>
        ...
        <title>Magarpatta-City-IT-Tower | A professional waterproofing contracting company</title>
        ...
        <link href="<?php echo base_url(); ?>/assets/vendors/flex-slider/flexslider.css" rel="stylesheet">
    ...
    <body>
            ...
            <div class="container">
                <div class="banner_inner_text">
                    ...
                    <ul>
                        ...
                        <li class="active"><a href="<?php echo base_url() ?>product/<?php echo $product->ID ?>"><?php echo $product->Name; ?> </a></li>
                    </ul>
                </div>
            </div>
        </section>
            ...
            <div class="row pre_construction_inner">
                <div class="col-md-6">
                    <div class="pre_construction_item">
                        <img src="<?php echo base_url(); ?>/assets/img/pre-cons-left.jpg" alt="">
                        <div class="pre_hover">
                            <h4>Vision</h4>
                            <p>To be the Pioneers in enhancing lifestyles of our Customers & Stakeholders by creating Integrated Sustainable Townships through an Inclusive Growth Model of partnering with the Landowners.</p>
                            <a class="slider_btn" href="https://magarpattacity.com/#About_Us">Read Details</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="pre_construction_right">
                        <img src="<?php echo base_url(); ?>/assets/img/pre-cons-right.jpg" alt="">
                        <div class="pre_hover">
                            <h4>Mission</h4>
                            <p>Our mission is to showcase a new outlook on life which lays emphasis on proper environmental control, good living standards, a modern educational system and state-of-the-art working conditions, all in a secure environment. </p>
                            <a class="slider_btn" href="https://magarpattacity.com/#About_Us">Read Details</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="project_single_inner">
                    <div class="project_single_slider">
                        <div id="slider" class="flexslider text-center">
                            <ul class="slides">
                                <li><img src="<?php echo base_url(); ?>product_images/<?php echo $product->Name ?>1.jpg" style="height:450px;width:750px;" class="img-responsive product-img" alt=""></li>
                                <li><img src="<?php echo base_url(); ?>product_images/<?php echo $product->Name ?>2.jpg" style="height:450px;width:750px;" class="img-responsive product-img" alt=""></li>
                                <li><img src="<?php echo base_url(); ?>product_images/<?php echo $product->Name ?>3.jpg" style="height:450px;width:750px;" class="img-responsive product-img" alt=""></li>
                                <li><img src="<?php echo base_url(); ?>product_images/<?php echo $product->Name ?>4.jpg" style="height:450px;width:750px;" class="img-responsive product-img" alt=""></li>
                        ...
                        <div id="carousel" class="flexslider">
                            <ul class="slides">
                                <li><img src="<?php echo base_url(); ?>product_images/<?php echo $product->Name ?>1.jpg" alt=""></li>
                                <li><img src="<?php echo base_url(); ?>product_images/<?php echo $product->Name ?>2.jpg" alt=""></li>
                                <li><img src="<?php echo base_url(); ?>product_images/<?php echo $product->Name ?>3.jpg" alt=""></li>
                                <li><img src="<?php echo base_url(); ?>product_images/<?php echo $product->Name ?>4.jpg" alt=""></li>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="project_summery">
                                <h4 class="project_title">Product Specification</h4>
                                <br>
                                ...
                                <ul>
                                    <li><a >Appearance  : <span><?php echo $product->prop_appearance ?></span> </a></li>
                                    <li><a >Specific Gravity : <span><?php echo $product->prop_specific_gravity ?> </span></a></li>
                                <!--<li><a >Value: <span>$154543</span></a></li> -->
                                    <li><a >Solid Percentage : <span><?php echo $product->prop_solid ?></span> </a></li>
                                    <li><a >pH : <span><?php echo $product->prop_PH ?></span></a></li>
                                    <li><a >Stabilization : <span><?php echo $product->prop_stablization ?></span></a></li>
                                    <!-- <li><a >Location: <span>13 Sholapur Bazar Road, Off East Street, Pune-411 001 </span></a></li>
                                    <li><a >Investors website: <span>https://magarpattacity.com </span></a></li> -->
                                </ul>
                            </div>
                            ...
                            <div class="panel-group project_collaps" id="accordion" role="tablist" aria-multiselectable="true">
                                <div class="panel panel-default">
                                    ...
                                    <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                                        ...
                                        <?php echo $product->Usage_product; ?>
                                        </div>
                                    </div>
                                </div>
                                <div class="panel panel-default">
                        ...
                        <div class="col-md-6">
                            <div class="project_discription">
                                <h4 class="project_title">Product Description</h4>
                            ...
                            <div class="project_s_tab">
                                <!-- Nav tabs -->
                                <h4 class="project_title ">How to Apply</h4><br>
                                <ul class="nav nav-tabs" role="tablist">
                                    ...
                                    <li role="presentation"><a href="#messages2" aria-controls="messages2" role="tab" data-toggle="tab">Step 4</a></li>
                                </ul>
                                <!-- Tab panes -->
                                <div class="tab-content">
                                    <div role="tabpanel" class="tab-pane active fade in" id="home">
                                        <p><?php echo $product->app_step1; ?></p>
                                      </div>
                                    <div role="tabpanel" class="tab-pane fade" id="profile">
                                        <p><?php echo $product->app_step2; ?></p>
                                    </div>
                                    <div role="tabpanel" class="tab-pane fade" id="messages">
                                        <p><?php echo $product->app_step3; ?></p>
                                    </div>
                                    <div role="tabpanel" class="tab-pane fade" id="messages2">
                                        <p><?php echo $product->app_step4; ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <br><br><div class="service_brochure text-center mt-4 mb-4">
                                <h4 class="project_title">Download Complete Product Brochure</h4>
                                ...
                                <a href="<?php echo base_url(); ?>/assets/assets/pdf/Zambre Constrotech Booklet.pdf" target="_blank"><i class="fa fa-file-pdf-o" aria-hidden="true"></i>Download PDF</a> -->
                                <a href="<?php echo base_url(); ?>product_images/<?php echo $product->Name; ?>.pdf" download="true" target="_blank"><i class="fa fa-file-pdf-o" aria-hidden="true"></i>Download Brochure</a>
        </div><br><br>
        <!--================Our Latest Project Area =================-->
        <section class="our_latest_project">
            <div class="container">
                <h3 class="out_title">Our Other Products</h3>
                <div class="our_latest_slider owl-carousel">
                <?php foreach($products as $prod){ ?>
                    <div class="item">
                        <div class="project_item">
                            <img src="<?php echo base_url(); ?>product_images/<?php echo $prod->Name; ?>1.jpg" alt="">
                            <div class="project_hover">
                                <div class="project_hover_inner">
                                    <div class="project_hover_content">
                                        <a href="#"><h4><?php echo $prod->Name; ?></h4></a>
                                        <p><?php echo $prod->short_desc;  ?></p>
                                        <a class="view_btn" href="<?php  echo base_url(); ?>product/<?php echo $prod->ID ?>">View Product</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <!-- <div class="item">
                        <div class="project_item">
                            <img src="<?php echo base_url(); ?>/assets/img/project/project-2/project-2.jpg" alt="">
                            <div class="project_hover">
                                <div class="project_hover_inner">
                                    <div class="project_hover_content">
                    ...
                    <div class="item">
                        <div class="project_item">
                            <img src="<?php echo base_url(); ?>/assets/img/project/project-2/project-3.jpg" alt="">
                            <div class="project_hover">
                                <div class="project_hover_inner">
                                    <div class="project_hover_content">
                                        <a href="#"><h4>Jahanara Vila</h4></a>
        ...
        <section class="get_quote_area project_contact">
            <div class="container">
                ...
                <div class="pull-right">
                    <a class="get_btn_black" href="contact.html">Contact Us</a>
                </div>
            </div>
        </section>
        <!--================End Get Quote Area =================-->
