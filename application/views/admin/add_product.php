      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top " id="navigation-example">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:void(0)">Add Product to Store</a>
          </div>
            ...
            <div class="col-md-8">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title h3">Add Product</h4>
                ...
                <div class="card-body">
                  <form method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <input type="number" max=1000 min=1 required class="form-control" name="quantity">
                        </div>
                      </div>
                    </div>
                    <!-- <div class="row">
                    ...
                    <button type="submit" class="btn btn-primary pull-right mt-4" name="submit">Add Product</button>
